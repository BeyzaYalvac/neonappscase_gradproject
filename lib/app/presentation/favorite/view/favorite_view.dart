...
import 'package:neonappscase_gradproject/app/presentation/favorite/widget/banner/favorite_deleted_banner.dart';
  ...
  Widget build(BuildContext context) {
    return BlocListener<FavoriteCubit, FavoriteState>(
      listenWhen: (previous, current) =>
          ...
          current.favoriteStatus == FavoriteStatus.deleted,
