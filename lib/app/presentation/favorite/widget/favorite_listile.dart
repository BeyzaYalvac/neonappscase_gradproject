    ...
    return ListTile(
      ...
      trailing: IconButton(
        ...
        onPressed: () {
          ...
          if (fav['id'] != null && fav['type'] == 'folder') {
            context.read<FavoriteCubit>().removeFavoriteFolder(fav['id']);
          } else if (fav['type'] == 'file' && fav['id'] != null) {
            context.read<FavoriteCubit>().removeFavoriteFileByKey(fav['id']);
          } else if (fav['type'] == 'image' && fav['id'] != null) {
            context.read<FavoriteCubit>().removeFavoriteImage(fav['id']);
          }
